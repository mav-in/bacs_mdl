...
$tottime = ($bacs->endtime - $bacs->starttime)/60;
$status = 0;
...
$results = $DB->get_records_select('bacs_submits', "submit_time <= $endtime AND contest_id = $id", array($params=null),'submit_id, user_id, contest_id, task_id, lang_id, solution, submit_time, result_id, test_num_failed, max_time_used, max_memory_used, info');
