...
class moodle1_mod_book_handler extends moodle1_mod_handler {
    ...
    public function get_paths() {
        return array(
            new convert_path('bacs', '/MOODLE_BACKUP/COURSE/MODULES/MOD/BACS',
                    array(
                        'renamefields' => array(
                            'summary' => 'intro',
                        ),
            ...
            new convert_path('bacs_chapters', '/MOODLE_BACKUP/COURSE/MODULES/MOD/BACS/CHAPTERS/CHAPTER',
                    array(
                        'newfields' => array(
    ...
    public function process_book($data) {
        ...
        $this->fileman = $this->converter->get_file_manager($contextid, 'mod_bacs');
        ...
        // start writing bacs.xml
        $this->open_xml_writer("activities/book_{$this->moduleid}/bacs.xml");
        $this->xmlwriter->begin_tag('activity', array('id' => $instanceid, 'moduleid' => $this->moduleid,
            'modulename' => 'bacs', 'contextid' => $contextid));
        $this->xmlwriter->begin_tag('bacs', array('id' => $instanceid));
    ...
    /**
     * This is executed when we reach the closing </MOD> tag of our 'bacs' path
     */
    public function on_book_end() {
        // finalize bacs.xml
        $this->xmlwriter->end_tag('bacs');
        $this->xmlwriter->end_tag('activity');
        $this->close_xml_writer();

        // write inforef.xml
        $this->open_xml_writer("activities/bacs_{$this->moduleid}/inforef.xml");
