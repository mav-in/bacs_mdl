...
require_once($CFG->dirroot . '/mod/bacs/backup/moodle2/restore_book_stepslib.php'); // Because it exists (must)
...
class restore_book_activity_task extends restore_activity_task {
    ...
    protected function define_my_steps() {
        ...
        $this->add_step(new restore_book_activity_structure_step('bacs_structure', 'bacs.xml'));
    }
    ...
    static public function define_decode_contents() {
        ...
        $contents[] = new restore_decode_content('bacs', array('intro'), 'bacs');
        $contents[] = new restore_decode_content('bacs_chapters', array('content'), 'bacs_chapter');
    ...
    static public function define_decode_rules() {
        ...
        $rules[] = new restore_decode_rule('BOOKINDEX', '/mod/bacs/index.php?id=$1', 'course');

        // book by cm->id
        $rules[] = new restore_decode_rule('BOOKVIEWBYID', '/mod/bacs/view.php?id=$1', 'course_module');
        $rules[] = new restore_decode_rule('BOOKVIEWBYIDCH', '/mod/bacs/view.php?id=$1&amp;chapterid=$2', array('course_module', 'baca_chapter'));

        // book by book->id
        $rules[] = new restore_decode_rule('BOOKVIEWBYB', '/mod/bacs/view.php?b=$1', 'bacs');
        $rules[] = new restore_decode_rule('BOOKVIEWBYBCH', '/mod/bacs/view.php?b=$1&amp;chapterid=$2', array('bacs', 'bacs_chapter'));

        // Convert old book links MDL-33362 & MDL-35007
        $rules[] = new restore_decode_rule('BOOKSTART', '/mod/bacs/view.php?id=$1', 'course_module');
        $rules[] = new restore_decode_rule('BOOKCHAPTER', '/mod/bacs/view.php?id=$1&amp;chapterid=$2', array('course_module', 'bacs_chapter'));
