...
require_once($CFG->dirroot.'/mod/bacs/backup/moodle2/backup_book_stepslib.php');    // Because it exists (must)
require_once($CFG->dirroot.'/mod/bacs/backup/moodle2/backup_book_settingslib.php'); // Because it exists (optional)
...
class backup_book_activity_task extends backup_activity_task {
    ...
    protected function define_my_steps() {
        ...
        $this->add_step(new backup_book_activity_structure_step('bacs_structure', 'bacs.xml'));
    }
