...
class backup_book_activity_structure_step extends backup_activity_structure_step {
    ...
    protected function define_structure() {
        ...
        $book = new backup_nested_element('bacs', array('id'), array(
        ...
        // Define sources
        $book->set_source_table('bacs', array('id' => backup::VAR_ACTIVITYID));
        $chapter->set_source_table('bacs_chapters', array('bookid' => backup::VAR_PARENTID));

        // Define file annotations
        $book->annotate_files('mod_bacs', 'intro', null); // This file area hasn't itemid
        $chapter->annotate_files('mod_bacs', 'chapter', 'id');
